...
# =============================================================================
#             Récupération des URLs d'une recherche sur l'Equipe
# =============================================================================
...
def get_articles_urls(nb):
    ...
    for i in range(1, nb + 1):
        url_search = 'https://www.lequipe.fr/recherche/search.php?r=coupe+du+monde+2022+qatar&jd=01&md=01&ad=2019&jf=01&mf=01&af=2019&t=ALL&adv=0&o=P&s=ALL&s1=efr&p=' + \
            str(i)
...
if __name__ == '__main__':
    ...
    filename = f'{now[:10]}_all_articles_lequipe'
