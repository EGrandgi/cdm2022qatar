...
# =============================================================================
#             Récupération des URLs d'une recherche sur 20minutes
# =============================================================================
...
def get_articles_urls(nb):
    ...
    for i in range(0, nb):
        url_search = 'https://www.google.com/search?q=coupe+du+monde+2022+qatar+%22coupe+du+monde+2022%22+site:https://www.20minutes.fr/&lr=&hl=fr&as_qdr=all&ei=_U9tXNjSJJXAgweGj7OwBg&start=' + \
            str(i) + '0'
...
if __name__ == '__main__':
    ...
    filename = f'{now[:10]}_all_articles_20min'
