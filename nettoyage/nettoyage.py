...
if __name__ == '__main__':
    ...
    df_articles_persons.to_csv(
        path + 'articles_persons.csv', encoding='utf-8', index=True, sep=';')
    df_articles_stadiums.to_csv(
        path + 'articles_stadiums.csv', encoding='utf-8', index=True, sep=';')